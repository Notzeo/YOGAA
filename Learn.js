...
function setup() {
  // 1️⃣ Get container and create canvas
  var videoContainer = document.getElementById("videoContainer");
  var car = createCanvas(600, 470);
  car.parent(videoContainer); // Attach canvas to HTML div

  // 2️⃣ Create video and attach it inside the same container
  video = createCapture(VIDEO);
  video.size(600, 470);
  video.parent(videoContainer); // 👈 This is the missing line
  video.hide(); // Keep raw video hidden, we’ll draw it manually

  // 3️⃣ Initialize poseNet
